...
namespace Imast.DataOps.Impl
{
    ...
    public class DapperNonQueryExecutor : DapperOperationExecutorBase<INonQueryExecutor>, INonQueryExecutor
    {
        ...
        /// <returns></returns>
        public async Task<int> ExecuteAsync(object param = null)
        {
            // the timeout to use
            ...
            return await this.MaybeTransactionalAsync(transaction => this.Connection.ExecuteAsync(source, param, transaction, timeout, type));
        }
    }
}